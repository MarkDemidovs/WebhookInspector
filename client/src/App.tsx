...
export default function Landing() {
    ...
    return (
        <div className="min-h-screen bg-bg flex flex-col">
            ...
            {/* nav */}
            <div className="flex items-center justify-between px-4 md:px-8 py-5 border-b border-border relative z-10">
                ...
                <div className="flex gap-2">
                    <button
                        ...
                        className="font-mono text-xs tracking-btn uppercase px-3 md:px-4 py-2 border border-border-2 text-subtle rounded-sm hover:border-border hover:text-secondary transition-all">
                        Sign in
                    </button>
                    <button
                        onClick={() => navigate('/signup')}
                        className="font-mono text-xs tracking-btn uppercase px-3 md:px-4 py-2 bg-accent text-bg font-medium rounded-sm hover:bg-accent-hover transition-all">
                        Get started
                    </button>
                </div>
            </div>
            ...
            {/* hero */}
            <section className="flex-1 grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-0 px-4 md:px-8 py-12 md:py-16 bg-grid relative">

                {/* left */}
                <div className="flex flex-col gap-5 max-w-lg md:pr-12">
                    ...
                    <h1 className="font-mono text-2xl md:text-3xl font-medium tracking-tight text-primary leading-tight">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <button
                            onClick={() => navigate('/signup')}
                            className="font-mono text-xs tracking-btn uppercase px-6 py-3 bg-accent text-bg font-medium rounded-sm hover:bg-accent-hover transition-all">
                            Create free account →
                        </button>
                        <button
                            onClick={() => navigate('/login')}
                            className="font-mono text-xs tracking-btn uppercase px-6 py-3 border border-border-2 text-subtle rounded-sm hover:border-border hover:text-secondary transition-all">
                            Sign in
                        </button>
                    </div>
                </div>
                ...
                <div className="bg-surface border border-border rounded-md overflow-hidden font-mono text-xs">
                    ...
                    <div className="p-5 flex flex-col gap-2 overflow-x-auto">
