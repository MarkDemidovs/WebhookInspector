            ...
            <section className="flex-1 grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-0 px-4 md:px-8 py-12 md:py-16 bg-grid relative">
                ...
                <div className="flex flex-col gap-5 max-w-lg md:pr-12">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                            onClick={() => navigate('/login')}
                            className="cursor-pointer font-mono text-xs tracking-btn uppercase px-6 py-3 border border-border-2 text-subtle rounded-sm hover:border-border hover:text-secondary transition-all">
                            Sign in
                        </button>
                    </div>
                </div>
